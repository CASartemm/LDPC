...
module tdma_calculate_vector (
    ...
    wire [511:0] out_row; // Строка из 128 бит, которую даёт shift_register_processor
    ...
    reg [511:0] acc; // Аккумулятор - сюда складываем результат вычислений
    ...
    reg [511:0] result; // Готовый результат, который будем выдавать
