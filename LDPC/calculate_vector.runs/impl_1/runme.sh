...
HD_PWD='C:/Users/arty/Documents/GitHub/LDPC/calculate_vector/calculate_vector.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_calculate_vector.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_calculate_vector.tcl -notrace
