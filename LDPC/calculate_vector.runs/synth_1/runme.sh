...
HD_PWD='C:/Users/arty/Documents/GitHub/LDPC/calculate_vector/calculate_vector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_calculate_vector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_calculate_vector.tcl
