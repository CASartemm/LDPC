...
clear;
load('Pg_2560.mat');  % Предполагаем, что матрица называется 'Pg'
if size(Pg, 1) ~= 2560 || size(Pg, 2) ~= 512
    error('Матрица Pg должна быть размером 2560х512');
end
if any(Pg(:) ~= 0 & Pg(:) ~= 1)
