...
fid = fopen('data_1728_Scrembled_bin.txt.', 'r');
if fid == -1
...
%remove_idx = [1:42, 59, 76, 813:817]; % Можно изменить на [1, 3, 5] для удаления нескольких позиций
 ...
 remove_idx = [1:42, 59, 76, 3501:3505]; % Можно изменить на [1, 3, 5] для удаления нескольких позиций
...
fid = fopen('modified_data_1728.txt', 'w');
if fid == -1
