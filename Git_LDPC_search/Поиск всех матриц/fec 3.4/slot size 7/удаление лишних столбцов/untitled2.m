...
fid = fopen('data_2016_Scrembled_bin.txt', 'r');
if fid == -1
...
%remove_idx = [1:42, 59, 76, 813:817]; % Можно изменить на [1, 3, 5] для удаления нескольких позиций
 ...
 remove_idx = [1:42, 59, 76, 2733:2737]; % Можно изменить на [1, 3, 5] для удаления нескольких позиций
...
fid = fopen('modified_data_2016.txt', 'w');
if fid == -1
