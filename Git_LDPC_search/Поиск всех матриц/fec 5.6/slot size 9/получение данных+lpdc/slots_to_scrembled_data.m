...
Slots = load("H:\поиск матриц\Поиск всех матриц\fec 5.6\slot size 9\получение данных+lpdc\Slots_2880.mat");
Slots = Slots.Slots;
...
bin_data_to_file(data_descr, "data_2880_Scrembled_bin.txt");
