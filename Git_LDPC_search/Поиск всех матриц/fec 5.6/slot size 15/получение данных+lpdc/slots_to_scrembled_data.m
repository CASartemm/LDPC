...
Slots = load("H:\поиск матриц\Поиск всех матриц\fec 5.6\slot size 5\получение данных+lpdc\Slots_1600.mat");
Slots = Slots.Slots;
...
bin_data_to_file(data_descr, "data_1600_Scrembled_bin.txt");
