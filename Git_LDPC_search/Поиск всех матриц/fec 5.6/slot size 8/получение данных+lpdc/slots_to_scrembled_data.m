...
Slots = load("H:\поиск матриц\Поиск всех матриц\fec 5.6\slot size 8\получение данных+lpdc\Slots_2560.mat");
Slots = Slots.Slots;
...
bin_data_to_file(data_descr, "data_2560_Scrembled_bin.txt");
