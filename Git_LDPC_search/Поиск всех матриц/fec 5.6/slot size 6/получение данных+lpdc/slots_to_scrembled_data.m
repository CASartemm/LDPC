...
Slots = load("H:\поиск матриц\Поиск всех матриц\fec 5.6\slot size 6\получение данных+lpdc\Slots_1920.mat");
Slots = Slots.Slots;
...
bin_data_to_file(data_descr, "data_1920_Scrembled_bin.txt");
