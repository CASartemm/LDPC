...
Slots = load("H:\поиск матриц\Поиск всех матриц\fec 5.6\slot size 4\получение данных+lpdc\Slots_1280");
Slots = Slots.Slots;
...
bin_data_to_file(data_descr, "data_1280_Scrembled_bin.txt");
