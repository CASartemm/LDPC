...
#
# Generated by export_simulation on Tue Jun 03 16:35:28 +0300 2025
#
################################################################################
...
'-reset_run' switch to the './ldpc_0.sh' script.
...
./ldpc_0.sh -noclean_files

For more information on the script, please type './ldpc_0.sh -help'.
