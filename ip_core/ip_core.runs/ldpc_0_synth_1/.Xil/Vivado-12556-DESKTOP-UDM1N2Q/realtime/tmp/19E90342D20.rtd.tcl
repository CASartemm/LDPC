...
set genomeRtd $env(RT_TMP)/19E90342D20.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {ldpc_v2_0_11_shift4__parameterized0__GBM2}]"
...
set genomeName [subst -nocommands -novariables {ldpc_v2_0_11_shift4__parameterized0__GBM2}]
