...
set genomeRtd $env(RT_TMP)/19F19158480.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {ldpc_v2_0_11_op_if__GB0}]"
...
set genomeName [subst -nocommands -novariables {ldpc_v2_0_11_op_if__GB0}]
