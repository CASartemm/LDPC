...
set genomeRtd $env(RT_TMP)/19F1000AC90.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {ldpc_v2_0_11_ld_top__GCB2}]"
...
set genomeName [subst -nocommands -novariables {ldpc_v2_0_11_ld_top__GCB2}]
